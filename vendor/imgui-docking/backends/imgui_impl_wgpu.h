...
bool ImGui_ImplWGPU_CheckSurfaceTextureOptimalStatus_Helper(
    WGPUSurfaceGetCurrentTextureStatus
        status);  // Check if the status of surface texture is optimal
...
void ImGui_ImplWGPU_DAWN_DeviceLostCallback_Helper(
    const wgpu::Device&, wgpu::DeviceLostReason reason,
    wgpu::StringView msg);  // DAWN Validation Layer callback: reason for device loss
void ImGui_ImplWGPU_DAWN_ErrorCallback_Helper(
    const wgpu::Device&, wgpu::ErrorType type,
    wgpu::StringView msg);        // DAWN Validation Layer callback: print error type
#  elif !defined(__EMSCRIPTEN__)  // WGPU-Native
void ImGui_ImplWGPU_WGPU_LogCallback_Helper(
    WGPULogLevel level, WGPUStringView msg,
    void* userdata);  // WGPU-Native log callback: print information based on request level.
#  endif
